...
- Phase 5 backend hazırlığı başladı: `Integrations` modülü default kapalı API/webhook readiness yüzeyiyle eklendi; API client/webhook lifecycle servisleri application katmanında hazırlandı, CRM/export ve delivery mutation endpoint'leri henüz yayınlanmaz.
