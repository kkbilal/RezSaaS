...
- Tenant/işletme yönetim endpoint'leri, privileged MFA/step-up ve ilk `PlatformAdmin` bootstrap prosedürü tamamlanmadan yayınlanmaz; bu aşamada yalnızca domain/persistence temeli kurulabilir.
