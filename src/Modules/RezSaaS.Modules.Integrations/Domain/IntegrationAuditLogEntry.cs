...
public sealed class IntegrationAuditLogEntry
{
    private IntegrationAuditLogEntry()
    {
    }
    ...
    public static IntegrationAuditLogEntry Create(
        Guid tenantId,
        Guid actorUserAccountId,
        string action,
        string detailsJson,
        DateTimeOffset occurredAtUtc)
    {
        return new IntegrationAuditLogEntry(
            Guid.CreateVersion7(),
            tenantId,
            actorUserAccountId,
            action,
